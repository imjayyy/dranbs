...
class ProductSpider(scrapy.Spider):
    ...
    start_urls = [
        ...
        'https://www2.hm.com/en_ca/sale/shopbyproductmen/view-all/_jcr_content/main/productlisting_9436.display.json?sort=stock&image-size=small&image=stillLife&offset=36&page-size=259'
    ]
